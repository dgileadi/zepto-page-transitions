...
" out");a.removeClass("ui-page-active");d.show();d.addClass(f+" in");d.addClass("ui-page-active");c&&(a.addClass("reverse"),d.addClass("reverse"))},1);window.setTimeout(function(){a.removeClass(f+" out");d.removeClass(f+" in");a.removeClass("reverse");d.removeClass("reverse");var c=d.data("title");c&&(document.title=c);a.trigger("pagehide",a);d.trigger("pageshow",d);b(document).trigger("pagechange",e);b('div[data-role="page"]').hide();d.show();l.domCache||(b("div.transition-recyclable").each(function(){var a=
